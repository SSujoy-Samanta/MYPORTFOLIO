...
export const projects: Project[] = [
    {
        ...
        technologies: ['Turbo Repo','Next.js', 'TypeScript', 'Node.js','Express','Postgress','Prisma','Tailwind CSS','Recoil','Docker'],
    ...
    },
    {
      ...
      technologies: ['Next.js', 'TypeScript', 'Node.js','Express','Postgress','Prisma','Tailwind CSS'],
      link: 'https://example.com',
      image: 'zapier.svg',
    },
    {
